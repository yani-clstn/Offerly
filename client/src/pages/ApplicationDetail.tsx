...
import { getApplication, getDocumentDownloadUrl } from '../api/applications'
...
export default function ApplicationDetail() {
  ...
  async function handleDocClick(docId: number) {
    try {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-offwhite border border-border rounded-xl p-4">
          ...
          <div className="relative pl-4">
            <div className="absolute left-0.75 top-1 bottom-1 w-px bg-border" />
